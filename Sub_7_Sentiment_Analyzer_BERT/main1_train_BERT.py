...
os.chdir(new_working_directory) # Sub_7_Sentiment_Analyzer_BERT/main1_train_BERT.py
...
print(f"End of training time: {time_end//3600}h {(time_end%3600)//60}m {time_end%60}s")
